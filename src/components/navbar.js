    ...
    return (
      <nav className={this.props.background}>
        <div className="container">
          <a className="logo" href={(this.props.home ? "#go-home" : "/koji/")}>
          ...
          <div className="right-nav">
            <ul>
              <li className="nav-item">
                <a className="nav-link go-thesis" href="/koji/">About</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/koji/investments">Investments</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/koji/read">Read</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/koji/listen">Listen</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/koji/contact">Contact</a>
              </li>
            </ul>
          </div>
