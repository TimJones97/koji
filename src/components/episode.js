...
class Episode extends Component {
  ...
  render() {
    return (
      <>
        <Link className="episode-link" to={"/listen/" + this.props.slug}>
            ...
            <article className="episode">
              <div className="episode-info">
                <div className="details">
                  ...
                  <span>&nbsp;|&nbsp;</span>
                  <p className="time">{this.props.duration}</p>
                  <span className="open mobile" to={this.props.slug}>Listen Now</span>
                </div>
              </div>
              ...
              <span className="open" to={this.props.slug}>Listen Now</span>
            </article>
          }
